...
def init():
    ...
    variables.append(Map(var="roof_sphere_color_pattern", choices=["rainbow_glass"]))
...
def decorate_roof_sphere(obj, options=Map()):
    ...
    if settings.roof_sphere_floating:
        ...
        sides = vg.sphere(boundaries.center, min_radius, tight=settings.roof_sphere_tight, options=Map(min_y_pct=.5))
